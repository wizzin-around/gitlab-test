...
or in your go code:
```os.Setenv("X_OTX_API_KEY", "ab91e98e6dcac6303bd1522d3542f91fcb4be176ea261ecd892d39e0d82a218b")```
 Check failure on line 37 in tests2.py

Wiz
Inc
. (97a425cbc2)
/ Wiz Secret Scanner
Secret found: SaaS API Key 🌐
SHA256: 7f7ecc40d5de14b5df8e3587fb045b35d749eb1db51351f17773f13a88f9f225
Service Name: AlienVault

For use with curl, or to write your own client, set the api key as a HTTP Header:
```X-OTX-API-KEY: "ab91e98e6dcac6303bd1522d4542f91fcb4be176ea261ecd892d39e0a82a218b"```
